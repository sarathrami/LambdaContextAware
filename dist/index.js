 ...
 * All rights reserved.
 * This is a modified runtime from https://raw.github.com/facebook
 */
...
!(function(global) {
  ...
  function wrap(savedContext, innerFn, outerFn, self, tryLocsList) {
    // If outerFn provided, then outerFn.prototype instanceof Generator.
    var generator = Object.create((outerFn || Generator).prototype);
    var context = new Context(tryLocsList || []);
    if(savedContext.context){
        context.prev = savedContext.context.prev;
        context.next = savedContext.context.next;
        context.done = savedContext.context.done;
    }
...
// END OF RUNTIME
var marked0$0 = [HouseStark].map(regeneratorRuntime.mark);
function HouseStark(event, context) {
    return regeneratorRuntime.wrap(context, function HouseStark$(context$1$0) {
...
var __transCompiledCode = HouseStark;
